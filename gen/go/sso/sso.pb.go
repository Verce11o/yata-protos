...
func (x *VerifyPasswordRequest) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
type ResetPasswordRequest struct {
	...
	Password   string `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`
	PasswordRe string `protobuf:"bytes,4,opt,name=passwordRe,proto3" json:"passwordRe,omitempty"`
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2b, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x18, 0x0a, 0x16, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x7f, 0x0a, 0x14, 0x52, 0x65, 0x73, 0x65, 0x74, 0x50, 0x61, 0x73,
	...
	0x64, 0x52, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61, 0x73, 0x73, 0x77,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x90, 0x04, 0x0a, 0x04, 0x41, 0x75, 0x74,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x1b, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x12, 0x5a, 0x10, 0x76,
	0x65, 0x72, 0x63, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x73, 0x73, 0x6f, 0x3b, 0x73, 0x73, 0x6f, 0x62,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*VerifyPasswordRequest)(nil),  // 8: auth.VerifyPasswordRequest
	(*VerifyPasswordResponse)(nil), // 9: auth.VerifyPasswordResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	16, // 0: auth.GetUserResponse.created_at:type_name -> google.protobuf.Timestamp
	16, // 1: auth.GetUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	12, // 5: auth.Auth.Login:input_type -> auth.LoginRequest
	14, // 6: auth.Auth.GetUserByID:input_type -> auth.GetUserRequest
	6,  // 7: auth.Auth.ForgotPassword:input_type -> auth.ForgotPasswordRequest
	8,  // 8: auth.Auth.VerifyPassword:input_type -> auth.VerifyPasswordRequest
	10, // 9: auth.Auth.ResetPassword:input_type -> auth.ResetPasswordRequest
	1,  // 10: auth.Auth.Register:output_type -> auth.RegisterResponse
	5,  // 11: auth.Auth.VerifyUser:output_type -> auth.VerifyResponse
	4,  // 12: auth.Auth.CheckVerify:output_type -> auth.CheckVerifyResponse
	13, // 13: auth.Auth.Login:output_type -> auth.LoginResponse
	15, // 14: auth.Auth.GetUserByID:output_type -> auth.GetUserResponse
	7,  // 15: auth.Auth.ForgotPassword:output_type -> auth.ForgotPasswordResponse
	9,  // 16: auth.Auth.VerifyPassword:output_type -> auth.VerifyPasswordResponse
	11, // 17: auth.Auth.ResetPassword:output_type -> auth.ResetPasswordResponse
