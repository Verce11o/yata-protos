...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x41, 0x74, 0x32, 0xaf, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.GetUserByID:input_type -> auth.GetUserRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.GetUserByID:output_type -> auth.GetUserResponse
